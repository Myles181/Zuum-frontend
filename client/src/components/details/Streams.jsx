...
const StreamingPlatformsModal = ({ 
  ...
  const platformIcons = {
    ...
    boomplay: <span className="text-2xl">🎵</span>,
    audiomark: <span className="text-2xl">🎶</span>
  };
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-13  left-0 right-0 z-50 rounded-t-3xl bg-white shadow-2xl h-[70vh] overflow-hidden"
          >
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className="w-10 h-10 flex items-center justify-center">
                        {platformIcons[platform] || platformIcons.audiomark}
                      </div>
