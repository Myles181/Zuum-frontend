...
import { useNavigate } from 'react-router-dom';
  ...
  const UploadBeats = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      // Form validation
      if (!formData.caption || !formData.description || !coverPhoto || !audioFile) {
        return;
      }
      ...
      <div className="min-h-screen bg-gray-50 my-13">
        ...
        <div className="max-w-2xl mx-auto bg-white overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            {success && (
              <div className="bg-green-50 p-4 rounded-lg border border-green-200 flex items-center text-green-700">
                <Check className="h-5 w-5 mr-2" />
                Beat successfully uploaded!
              </div>
            )}
